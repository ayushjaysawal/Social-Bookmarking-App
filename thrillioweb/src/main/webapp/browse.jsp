...
<body style="font-family:Arial;font-size:20px;">
	...
	<form method="POST" action="<%=request.getContextPath()%>/bookmark/searchbook">
      <fieldset>
	    ...
	    <table>
	    	...
	    	<tr>	
        		...
        		<td>&nbsp;</td>
        		<td><input type="submit" name="submitSearchForm" value="searchbook"></td>
        	</tr>
        	<tr>
        		<td><label>Didn't find book!:</label></td>
        		<td>
        			<a href = "<%=request.getContextPath()%>/userBook.jsp" style="font-size:18px;color:#0058A6;font-weight:bold;text-decoration:none">AddBook</a>
        		</td>        
        	</tr>
        </table>
	  </fieldset>      
