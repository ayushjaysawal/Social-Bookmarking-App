...
<body style="font-family:Arial;font-size:20px;">
	<div style="height:65px;align: center;background: #DB5227;font-family: Arial;color: white;"">
		...
		<div style="height:25px;background: #DB5227;font-family: Arial;color: white;">
			<b>
			<a href="<%=request.getContextPath()%>/bookmark" style="font-size:16px;color:white;margin-left:1150px;text-decoration:none;">Book</a>
	...
	<table>
	  <tr> 
	  <td>   
	  <div style="font-size: 12px;color: #333333;padding: 15px 0px 0px;border-bottom: #333333 1px solid;clear: both;">Books</div>
	  <br><br>
    <c:choose>
			   ...
			   <c:forEach var = "book" items="${books}">
			     <tr>
				   ...
				   <td style="color:gray;">
					 ...
					 <br>
					 <a href = "<%=request.getContextPath()%>/bookmark/remove?bid=${book.id}" style="font-size:12px;color:#0058A6;font-weight:bold;text-decoration:none">Remove</a>
					</td>
				  </tr>
				  <tr>
		     	    <td>&nbsp;</td>
     ...
     <c:otherwise>
		<br><br>
       	<span style="font-size: 24px;color: #333333;margin:100px;">No Books!</span>
     </c:otherwise>
    </c:choose>
    </td>
     
    <td style="padding-left: 700px; vertical-align: top;">
       <div style="font-size: 12px;color: #333333;padding: 15px 0px 0px;border-bottom: #333333 1px solid;clear: both;">Movies</div>
         <c:choose>
     ...
     <c:otherwise>
		<br><br>
       	<span style="font-size: 24px;color: #333333;margin:100px;">No Movies!</span>
     </c:otherwise>
    </c:choose>
    </td>
    </tr>
			   ...
			   <c:forEach var = "book" items="${userbooks}">
			     <tr>
				   <td style="color:gray;">
					 ...
					 Publication Year: <span style="color: #B13100;">${book.publicationYear}</span>
					 <br>
					 <a href = "<%=request.getContextPath()%>/bookmark/udeletebook?bid=${book.id}" style="font-size:12px;color:#0058A6;font-weight:bold;text-decoration:none">Remove</a>
					</td>
				  </tr>
				  <tr>
		     	    <td>&nbsp;</td>
		...
		<c:when test="${!empty(usermovies)}">
	     ...
	     <tr>
		   <td style="color:gray;">
			 ...
			 Release Year: <span style="color: #B13100;">${movie.releaseyear}</span>
			 <br>
			 <a href = "<%=request.getContextPath()%>/bookmark/udeletemovie?mid=${movie.id}" style="font-size:12px;color:#0058A6;font-weight:bold;text-decoration:none">Remove</a>
		   </td>
		  </tr>
		  <tr>
     	    <td>&nbsp;</td>
