...
<body>
	<div style="height:65px;align: center;background: #DB5227;font-family: Arial;color: white;"">
		...
		<div style="height:25px;background: #DB5227;font-family: Arial;color: white;">
			<b>
			<a href="<%=request.getContextPath()%>/bookmark/movie" style="font-size:16px;color:white;margin-left:1150px;text-decoration:none;">Books</a>
			</b>
		</div>	         
	</div>
	<br><br>
	<form method="POST" action="<%=request.getContextPath()%>/bookmark/addUserMovie">
      <fieldset>
