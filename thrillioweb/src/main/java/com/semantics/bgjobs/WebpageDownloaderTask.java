...
import com.semantics.util.HttpConnect;
import com.semantics.util.IOUtil;
			...
			try {
				if(!future.isCancelled()) {
					...
					if(webPage!=null) {
						...
						System.out.println("Webpage not Downloade"+webLink.getUrl());
					}
				}
				else {
